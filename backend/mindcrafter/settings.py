...
SECRET_KEY = env.str("DJANGO_SECRET_KEY", default="unsafe",)
...
STATIC_URL = 'static/'
# The files will persist in container in /static outside of the app root, until copied for external nginx retrieval.
STATIC_ROOT = "/static"
